namespace RobinHood70.WallE.Base
{
	...
	public interface IWikiAbstractionLayer
	{
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Allcategories">Allcategories</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of categories.</returns>
		IReadOnlyList<AllCategoriesItem> AllCategories(AllCategoriesInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Alldeletedrevisions">Alldeletecrevisions</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Allimages">Allimages</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Alllinks">Alllinks</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of links.</returns>
		IReadOnlyList<AllLinksItem> AllLinks(AllLinksInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Allmessages">Allmessages</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of messages.</returns>
		IReadOnlyList<AllMessagesItem> AllMessages(AllMessagesInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Allpages">Allpages</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Allrevisions">Allrevisions</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Allusers">Allusers</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of users.</returns>
		IReadOnlyList<AllUsersItem> AllUsers(AllUsersInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Backlinks">Backlinks</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of links.</returns>
		IReadOnlyList<BacklinksItem> Backlinks(BacklinksInput input);

		/// <summary>Blocks a user. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Block">Block</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the block.</returns>
		BlockResult Block(BlockInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Blocks">Blocks</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of blocks.</returns>
		IReadOnlyList<BlocksResult> Blocks(BlocksInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Categorymembers">Categorymembers</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of category members.</returns>
		IReadOnlyList<CategoryMembersItem> CategoryMembers(CategoryMembersInput input);

		/// <summary>Checks a token. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Checktoken">Checktoken</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the checked token.</returns>
		CheckTokenResult CheckToken(CheckTokenInput input);

		/// <summary>Clears the user's "has message" flag. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Clearhasmsg">Clearhasmsg</a> API module.</summary>
		/// <returns>Whether the attempt was successful.</returns>
		bool ClearHasMessage();

		/// <summary>Compares two revisions or pages. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Compare">Compare</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the comparison.</returns>
		CompareResult Compare(CompareInput input);

		/// <summary>Creates an account. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Createaccount">Createaccount</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the account created.</returns>
		CreateAccountResult CreateAccount(CreateAccountInput input);

		/// <summary>Deletes a page. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Delete">Delete</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Deletedrevisions">Deletedrevisions</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of deleted revisions.</returns>
		IReadOnlyList<DeletedRevisionsItem> DeletedRevisions(ListDeletedRevisionsInput input);

		/// <summary>Edits a page. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Edit">Edit</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the edit.</returns>
		EditResult Edit(EditInput input);

		/// <summary>Emails a user. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Emailuser">Emailuser</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the e-mail that was sent.</returns>
		EmailUserResult EmailUser(EmailUserInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Expandtemplates">Expandtemplates</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the expanded templates.</returns>
		ExpandTemplatesResult ExpandTemplates(ExpandTemplatesInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Externalurlusage">Externalurlusage</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Feedcontributions">Feedcontributions</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>The raw XML of the Contributions RSS feed.</returns>
		string FeedContributions(FeedContributionsInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Feedrecentchanges">Feedrecentchanges</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>The raw XML of the Recent Changes RSS feed.</returns>
		string FeedRecentChanges(FeedRecentChangesInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Feedwatchlist">Feedwatchlist</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>The raw XML of the Watchlist RSS feed.</returns>
		string FeedWatchlist(FeedWatchlistInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Filearchive">Filearchive</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of file archives.</returns>
		IReadOnlyList<FileArchiveItem> FileArchive(FileArchiveInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Filerepoinfo">Filerepoinfo</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Reverts a file to an older version. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Filerevert">Filerevert</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the file reversion.</returns>
		FileRevertResult FileRevert(FileRevertInput input);

		/// <summary>Gets help information. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Help">Help</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>The API help for the module(s) requested.</returns>
		HelpResult Help(HelpInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Imagerotate">Imagerotate</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Iwbacklinks">Iwbacklinks</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Langbacklinks">Langbacklinks</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		PageSetResult<PageItem> LoadPages(QueryPageSetInput pageSetInput, IEnumerable<IPropertyInput> propertyInputs, Func<PageItem> pageFactory);
		...
		/// <summary>Logs the user in. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Login">Login</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the login.</returns>
		LoginResult Login(LoginInput input);

		/// <summary>Logs the user out. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Logout">Logout</a> API module.</summary>
		// The return value from the wiki is an empty object, so this is a void function.
		void Logout();

		/// <summary>Adds, removes, activates, or deactivates a page tag. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Managetags">Managetags</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the altered tag.</returns>
		ManageTagsResult ManageTags(ManageTagsInput input);

		/// <summary>Merges the history of two pages. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Mergehistory">Mergehistory</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the merge.</returns>
		MergeHistoryResult MergeHistory(MergeHistoryInput input);

		/// <summary>Moves a page, and optionally, it's talk/sub-pages. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Move">Move</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Pagepropnames">Pagepropnames</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of proerty names.</returns>
		IReadOnlyList<string> PagePropertyNames(PagePropertyNamesInput input);

		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Pageswithprop">Pageswithprop</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Paraminfo">Paraminfo</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Parses custom text, a page, or a revision. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Parse">Parse</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>The result of the parse.</returns>
		ParseResult Parse(ParseInput input);

		/// <summary>Patrols a recent change or revision. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Patrol">Patrol</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		PageSetResult<PurgeResult> Purge(PurgeInput input);
		...
		/// <summary>Returns data corresponding to the <a href="https://www.mediawiki.org/wiki/API:Recentchanges">Recentchanges</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of recent changes.</returns>
		IReadOnlyList<RecentChangesItem> RecentChanges(RecentChangesInput input);

		/// <summary>Resets a user's password. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Resetpassword">Resetpassword</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Hides one or more revisions from those without permission to view them. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Revisiondelete"></a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the deleted revisions.</returns>
		RevisionDeleteResult RevisionDelete(RevisionDeleteInput input);

		/// <summary>Rolls back all of the last user's edits to a page. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Rollback">Rollback</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the rollback.</returns>
		RollbackResult Rollback(RollbackInput input);

		/// <summary>Returns Really Simple Discovery information. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Rsd">Rsd</a> API module.</summary>
		...
		/// <summary>Returns information about the site. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Siteinfo">Siteinfo</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>The requested site information.</returns>
		SiteInfoResult SiteInfo(SiteInfoInput input);

		/// <summary>Returns information about <a href="https://www.mediawiki.org/wiki/Manual:UploadStash">stashed</a> files. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Stashimageinfo">Stashimageinfo</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Adds or removes tags based on revision IDs, log IDs, or Recent Changes IDs. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Tag">Tag</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the tag/untag.</returns>
		IReadOnlyList<TagItem> Tag(TagInput input);

		/// <summary>Displays information about all tags available on the wiki. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Tags">Tags</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>A list of tag information.</returns>
		IReadOnlyList<TagsItem> Tags(TagsInput input);

		/// <summary>Unblocks a user. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Unblock">Unblock</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the unblock operation and the user affected.</returns>
		UnblockResult Unblock(UnblockInput input);

		/// <summary>Undeletes a page or specific revisions thereof (by file ID or date/time). Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Undelete">Undelete</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the undeleted page.</returns>
		UndeleteResult Undelete(UndeleteInput input);

		/// <summary>Uploads a file to the wiki. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Upload">Upload</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the uploaded file.</returns>
		UploadResult Upload(UploadInput input);

		/// <summary>Retrieves a user's contributions. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Usercontribs">Usercontribs</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Returns information about the current user. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Userinfo">Userinfo</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the current user.</returns>
		UserInfoResult UserInfo(UserInfoInput input);

		/// <summary>Adds or removes user rights (based on rights groups). Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Userrights">Userrights</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Retrieves information about specific users on the wiki. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Users">Users</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		/// <returns>Information about the users.</returns>
		IReadOnlyList<UsersItem> Users(UsersInput input);

		/// <summary>Watches or unwatches pages for the current user. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Watch">Watch</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Retrieve detailed information about the current user's watchlist. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Watchlist">Watchlist</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
		...
		/// <summary>Retrieve some or all of the current user's watchlist. Corresponds to the <a href="https://www.mediawiki.org/wiki/API:Watchlistraw">Watchlistraw</a> API module.</summary>
		/// <param name="input">The input parameters.</param>
