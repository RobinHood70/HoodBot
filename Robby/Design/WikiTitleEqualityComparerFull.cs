namespace RobinHood70.Robby.Design
{
	...
	public class WikiTitleEqualityComparerFull : EqualityComparer<IWikiTitle>
	{
		...
		public override int GetHashCode(IWikiTitle obj) => obj == null ? 0 : CompositeHashCode(obj.Namespace.GetHashCode(), obj.PageName.GetHashCode(), obj.Key.GetHashCode());
	}
}
