namespace RobinHood70.Robby.Design
{
	...
	{
		/// <summary>Convert a collection of IWikiTitles to their full page names.</summary>
		...
		public static IEnumerable<string> ToFullPageNames(this IEnumerable<IWikiTitle> titles)
		{
			if (titles != null)
			{
