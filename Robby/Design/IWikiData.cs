...
public interface IWikiData<TThis>
	where TThis : class
{
	#region Methods
	...
	TThis GetBacklinks(string title);

	/// <summary>Adds backlinks (aka, What Links Here) of the specified title to the collection.</summary>
	/// <param name="title">The title.</param>
	/// <param name="linkTypes">The link types of the pages to retrieve.</param>
	TThis GetBacklinks(string title, BacklinksTypes linkTypes);
	...
	TThis GetBacklinks(string title, BacklinksTypes linkTypes, bool includeRedirectedTitles);

	/// <summary>Adds backlinks (aka, What Links Here) of the specified title to the collection.</summary>
	/// <param name="title">The title.</param>
	/// <param name="linkTypes">The link types of the pages to retrieve.</param>
	/// <param name="redirects">Whether or not to include redirects in the results.</param>
	TThis GetBacklinks(string title, BacklinksTypes linkTypes, Filter redirects);
	...
	/// <param name="includeRedirectedTitles">if set to <see langword="true"/>, pages linking to <paramref name="title"/> via a redirect will be included.</param>
	/// <param name="redirects">Whether or not to include redirects in the results.</param>
	TThis GetBacklinks(string title, BacklinksTypes linkTypes, bool includeRedirectedTitles, Filter redirects);
	...
	TThis GetBacklinks(string title, BacklinksTypes linkTypes, bool includeRedirectedTitles, Filter redirects, int ns);
	...
	TThis GetCategories(string prefix);
	...
	TThis GetCategoryMembers(string category, bool recurse);
	...
	TThis GetCategoryMembers(string category, CategoryMemberTypes categoryMemberTypes, bool recurse);
	...
	TThis GetFiles(string from, string to);
	...
	TThis GetFiles(DateTime start, DateTime end);
	...
	TThis GetLinksToNamespace(int ns, string prefix);
	...
	TThis GetLinksToNamespace(int ns, string from, string to);

	/// <summary>Adds pages in the given the namespace to the collection.</summary>
	/// <param name="ns">The namespace.</param>
	TThis GetNamespace(int ns);

	/// <summary>Adds pages in the given the namespace to the collection.</summary>
	/// <param name="ns">The namespace.</param>
	/// <param name="redirects">Whether or not to include pages that are redirects.</param>
	TThis GetNamespace(int ns, Filter redirects);

	/// <summary>Adds pages in the given the namespace to the collection.</summary>
	/// <param name="ns">The namespace.</param>
	/// <param name="redirects">Whether or not to include pages that are redirects.</param>
	/// <param name="prefix">The prefix of the pages to load.</param>
	TThis GetNamespace(int ns, Filter redirects, string prefix);
	...
	/// <param name="from">The page name to start at (inclusive).</param>
	/// <param name="to">The page name to end at (inclusive).</param>
	TThis GetNamespace(int ns, Filter redirects, string from, string to);
	...
	TThis GetPageCategories(IEnumerable<Title> titles);

	/// <summary>Adds category pages that are referenced by the given titles to the collection.</summary>
	/// <param name="titles">The titles whose categories should be loaded.</param>
	/// <param name="hidden">Filter for hidden categories.</param>
	TThis GetPageCategories(IEnumerable<Title> titles, Filter hidden);

	/// <summary>Adds category pages that are referenced by the given titles to the collection.</summary>
	/// <param name="titles">The titles whose categories should be loaded.</param>
	/// <param name="hidden">Filter for hidden categories.</param>
	/// <param name="limitTo">Limit the results to these categories.</param>
	TThis GetPageCategories(IEnumerable<Title> titles, Filter hidden, IEnumerable<string> limitTo);

	/// <summary>Adds pages that are linked to by the given titles to the collection.</summary>
	/// <param name="titles">The titles whose categories should be loaded.</param>
	TThis GetPageLinks(IEnumerable<Title> titles);

	/// <summary>Adds pages that are linked to by the given titles to the collection.</summary>
	/// <param name="titles">The titles whose categories should be loaded.</param>
	/// <param name="namespaces">The namespaces to limit results to.</param>
	TThis GetPageLinks(IEnumerable<Title> titles, IEnumerable<int>? namespaces);

	/// <summary>Adds pages that link to the given titles to the collection.</summary>
	/// <param name="titles">The titles.</param>
	TThis GetPageLinksHere(IEnumerable<Title> titles);
	...
	TThis GetPagesWithProperty(string property);

	/// <summary>Adds pages that transclude the given titles to the collection.</summary>
	/// <param name="titles">The titles.</param>
	TThis GetPageTranscludedIn(IEnumerable<Title> titles);

	/// <summary>Adds pages that transclude the given titles to the collection.</summary>
	/// <param name="titles">The titles.</param>
	TThis GetPageTranscludedIn(IEnumerable<string> titles);

	/// <summary>Adds pages that transclude the given titles to the collection.</summary>
	/// <param name="titles">The titles.</param>
	TThis GetPageTranscludedIn(params string[] titles);
	...
	TThis GetPageTransclusions(IEnumerable<Title> titles);

	/// <summary>Adds pages that are transcluded from the given titles to the collection.</summary>
	/// <param name="titles">The titles whose transclusions should be loaded.</param>
	/// <param name="limitTo">Limit the results to these transclusions.</param>
	TThis GetPageTransclusions(IEnumerable<Title> titles, IEnumerable<string> limitTo);

	/// <summary>Adds pages that are transcluded from the given titles to the collection.</summary>
	/// <param name="titles">The titles whose transclusions should be loaded.</param>
	/// <param name="namespaces">Limit the results to these namespaces.</param>
	TThis GetPageTransclusions(IEnumerable<Title> titles, IEnumerable<int> namespaces);
	...
	TThis GetPrefixSearchResults(string prefix);

	/// <summary>Adds prefix-search results to the collection.</summary>
	/// <param name="prefix">The prefix to search for.</param>
	/// <param name="namespaces">The namespaces to search in.</param>
	/// <remarks>As noted on the API page for PrefixSearch, this is <em>not</em> the same as other prefix-based methods in that it doesn't strictly look for pages to start with the same literal letters. It's run through the installed search engine instead, and may include such things as word substitution, spelling correction, etc.</remarks>
	TThis GetPrefixSearchResults(string prefix, IEnumerable<int> namespaces);

	/// <summary>Adds protected page results to the collection.</summary>
	TThis GetProtectedPages();

	/// <summary>Adds protected page results to the collection.</summary>
	/// <param name="protectionTypes">The protection types to retrieve.</param>
	TThis GetProtectedPages(ProtectionTypes protectionTypes);

	/// <summary>Adds protected page results to the collection.</summary>
	/// <param name="protectionTypes">The protection types to retrieve.</param>
	/// <param name="protectionLevels">The levels to retrieve.</param>
	TThis GetProtectedPages(ProtectionTypes protectionTypes, ProtectionLevels protectionLevels);
	...
	TThis GetProtectedPages(IEnumerable<string> protectionTypes, IEnumerable<string> protectionLevels);
	...
	TThis GetRecentChanges(string tag);
	...
	TThis GetRecentChanges(RecentChangesTypes types);
	...
	TThis GetRecentChanges(Filter anonymous, Filter bots, Filter minor, Filter patrolled, Filter redirects);

	/// <summary>Adds recent changes pages to the collection, filtered to a date range.</summary>
	/// <param name="start">The date to start at (inclusive).</param>
	/// <param name="end">The date to end at (inclusive).</param>
	TThis GetRecentChanges(DateTime? start, DateTime? end);
	...
	TThis GetRecentChanges(DateTime start, bool newer);
	...
	TThis GetRecentChanges(DateTime start, bool newer, int count);
	...
	TThis GetRecentChanges(string user, bool exclude);
	...
	TThis GetRecentChanges(RecentChangesOptions options);

	/// <summary>Adds redirects to a namespace to the collection.</summary>
	/// <param name="ns">The namespace.</param>
	TThis GetRedirectsToNamespace(int ns);

	/// <summary>Adds redirects to a namespace to the collection.</summary>
	/// <param name="ns">The namespace.</param>
	/// <param name="prefix">The prefix of the pages to load.</param>
	TThis GetRedirectsToNamespace(int ns, string prefix);
	...
	TThis GetRedirectsToNamespace(int ns, string from, string to);
	...
	TThis GetRevisions(DateTime start, bool newer);

	/// <summary>Adds pages from a range of revisions to the collection.</summary>
	/// <param name="start">The date to start at (inclusive).</param>
	/// <param name="newer">if set to <see langword="true"/>, revisions from the start date to the most recent will be returned; otherwise, changes from the start date to the oldest will be returned.</param>
	/// <param name="count">The number of revisions to return.</param>
	TThis GetRevisions(DateTime start, bool newer, int count);

	/// <summary>Adds search results to the collection.</summary>
	/// <param name="search">What to search for.</param>
	TThis GetSearchResults(string search);

	/// <summary>Adds search results to the collection.</summary>
	/// <param name="search">What to search for.</param>
	/// <param name="namespaces">The namespaces to search in.</param>
	TThis GetSearchResults(string search, IEnumerable<int> namespaces);
	...
	TThis GetSearchResults(string search, WhatToSearch whatToSearch);
	...
	/// <param name="namespaces">The namespaces to search in.</param>
	/// <remarks>Not all search engines support all <paramref name="whatToSearch"/> options.</remarks>
	TThis GetSearchResults(string search, WhatToSearch whatToSearch, IEnumerable<int> namespaces);
	...
	TThis GetTransclusions(string prefix);
	...
	TThis GetTransclusions(int ns, string prefix);
	...
	TThis GetTransclusions(string from, string to);
	...
	TThis GetTransclusions(int ns, string from, string to);
